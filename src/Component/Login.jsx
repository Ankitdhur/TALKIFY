...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      ...
      // Optional: update context manually if not using onAuthStateChanged
      // const { photoURL, displayName, email } = authData.user;
      // setUserData({ email, photoURL, name: displayName });
    ...
    <>
      ...
      <div className="bg-primary h-[220px]">
        <div className="flex justify-center sm:justify-start sm:ml-[200px] pt-[40px] items-center gap-2">
          <img src="/TalkifyLogo.png" className="h-12 mt-1" alt="Talkify logo" />
